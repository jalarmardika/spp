	...
	<div class="row">
		<div class="col-md-12">
			<div class='alert alert-warning alert-dismissible mt-3 mb-3'>
				<b>Perhatian !</b> Jika ada siswa yang telah dibuatkan tagihan lalu dipindah kelasnya melalui halaman ini, maka tagihan tetap ada di kelas sebelumnya!
			</div>
		</div>
		<div class="col-md-9">
				...
				<div class="card-body">
					...
					if(isset($_GET['pesan'])){
						if($_GET['pesan']=="berhasil"){
							...
							<b>Proses Kenaikan/Pemindahan Kelas Berhasil !</b>
							</div>";
						}else{
					...
					<!-- begin of form -->
					<form action="kenaikan_kelas_aksi.php" method="post">
			...
			<div class="col-md-3">
				<div class="card shadow-lg mb-5">
					<div class="card-body">
						...
						<button type="submit" name="submit" class="btn btn-block btn-primary btn-sm mb-2">Proses Pindah/Naik Kelas</button>	
					</div>
				</div>
			</div>
		</form><!-- end form -->
